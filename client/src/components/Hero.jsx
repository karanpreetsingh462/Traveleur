...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>Where Luxury Meets Comfort</p>
      <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>
        Experience Distinctive Hospitality and Comfort
      </h1>
      <p className='max-w-[520px] mt-2 text-sm md:text-base'>
        Curated experiences designed to exceed expectations. Begin your journey with trusted expertise.
      </p>
