...
//   return (
//     <div>
//         <Title align='left' title='Dashboard' subTitle='Monitor your room listings, track bookings and analyze revenue—all in one place. Stay updated with real-time insights to ensure smooth operations.'/>
...
//                     <p className='text-neutra1-400 text-base'>{dashboardData.totalBookings}</p>
//                 </div>
//             </div>
//         {/* Total revenue */}
//             <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
...
//                     <p className='text-neutra1-400 text-base'>{currency} {dashboardData.totalRevenue}</p>
//                     </div>
//             </div>
//         </div>
//         {/* recent bookings */}
//         <h2 className= 'text-xl text-blue-950/70 font-medium mb-5 '>Recent Bookings</h2>
//         <div className='w-full max-w-3xl text-left border border-gray-30 rounded-lg max-h-80 overflow-y-scroll'>
