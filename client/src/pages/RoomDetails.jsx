...
const RoomDetails = () => {
    ...
    const checkAvailability= async()=>{
        try {
            ...
            if(checkInDate>= checkOutDate){
                toast.error('Check-ln Date should be less than Check-Out Date')
                return;
            }
  ...
  return room && (
    ...
    <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
        <p>Guests will be allocated on the ground floor according to availability. You get a comfortable two-bedroom apartment that has a true city feeling. The price quoted is for two guests,at the guest slot please mark the number of guests to get the exact price for groups. The guests will be allocated ground floor according to availability. You get a comfortable two bedroom apartment that has a true city feeling.</p>
    </div>
